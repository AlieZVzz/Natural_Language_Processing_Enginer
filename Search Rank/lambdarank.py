...
from utils import eval_cross_entropy_loss, eval_ndcg_at_k, get_device, get_ckptdir, init_weights, load_train_vali_data, \
    get_args_parser, save_to_ckpt
...
class LambdaRank(nn.Module):
    ...
    def dump_param(self):
        for i in range(1, self.fc_layers + 1):
            ...
            try:
                weight_ratio = weight_grad_norm / weight_norm if weight_norm else float(
